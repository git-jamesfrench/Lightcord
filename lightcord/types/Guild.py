...
from lightcord.types.User import AvatarDecorationData, User
from lightcord.types.Role import Role
from lightcord.types.Emoji import Emoji
from lightcord.types.Sticker import Sticker
    
class WelcomeScreenChannel(TypeData):
    channel_id: Snowflake
    description: str
    emoji_id: Snowflake
    emoji_name: str

class WelcomeScreen(TypeData):
    description: str
    welcome_channels: List[WelcomeScreenChannel]

class Member(TypeData):
    user: User
    nick: str
    avatar: str
    banner: str
